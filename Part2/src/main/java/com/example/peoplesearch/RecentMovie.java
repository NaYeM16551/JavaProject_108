...
public class RecentMovie implements Serializable {
   // static List<Movie> ClintMovie=Client.ClientMovielist;
    @FXML
    ...
    void initialize()
    {
        ...
        ArrayList<Movie> MostRecent=new ArrayList<>();
        int c=Client.ClientMovielist.get(0).ReleaseYear;
        ...
        table.setItems(FXCollections.observableArrayList(MostRecent));


    }

    @FXML
    public void onRefreshClick(ActionEvent actionEvent) throws Exception{
